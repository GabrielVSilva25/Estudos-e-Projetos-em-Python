...
# de participantes.
# Peça à pessoa usuária para fornecer o número de participantes do sorteio e devolva para ela o número
# sorteado.
from random import randint
numero_Participantes = int(input('Informe a quantidade de participantes: '))
